...
//             <KanbanBoard activeTeam={activeTeam} />{" "}
//             {/* pass team info if needed */}
//           </div>
//         </div>
//       )}{" "}
//     </div>
...
import WorkspaceDashboard from "./work-space";
import InviteMember from "./invite-member";
import KanbanBoard from "./kanban-board"; // Preserve your Kanban style
    ...
    <div className="min-h-screen bg-zinc-900 text-white p-6 w-full">
      ...
      {activeTeam && (
        <div className="bg-zinc-800 p-6 rounded-lg shadow-lg">
          ...
          <InviteMember />
          <KanbanBoard /> {/* Keeps your original Kanban UI */}
        </div>
      )}
    </div>
  );
